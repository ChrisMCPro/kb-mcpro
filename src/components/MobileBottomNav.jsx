...
const rawCategories = [
  {
    ...
    path: "/docs/category/home",
  },
  {
    icon: "/img/icons/calendar.svg",
    label: { fr: "Calendrier", en: "Calendar", es: "Calendario" },
    path: "/docs/category/calendar",
  },
  {
    icon: "/img/icons/players.svg",
    label: { fr: "Joueurs", en: "Players", es: "Jugadores" },
    path: "/docs/category/players",
  },
  {
    icon: "/img/icons/sessions.svg",
    label: { fr: "Séances", en: "Sessions", es: "Sesiones" },
    path: "/docs/category/sessions",
  },
  {
    icon: "/img/icons/exercises.svg",
    label: { fr: "Exercices", en: "Exercises", es: "Ejercicios" },
    path: "/docs/category/exercises",
  },
  {
    icon: "/img/icons/game-football.svg",
    label: { fr: "Matchs", en: "Games", es: "Partidos" },
    path: "/docs/category/games",
  },
  {
    icon: "/img/icons/insights.svg",
    label: { fr: "Insights", en: "Insights", es: "Insights" },
    path: "/docs/category/insights",
  },
  {
    icon: "/img/icons/medical.svg",
    label: { fr: "Médical", en: "Medical", es: "Médico" },
    path: "/docs/category/medical",
  },
  {
    icon: "/img/icons/nutrition.svg",
    label: { fr: "Nutrition", en: "Nutrition", es: "Nutrición" },
    path: "/docs/category/nutrition",
  },
  {
    icon: "/img/icons/performance.svg",
    label: { fr: "Performance", en: "Performance", es: "Rendimiento" },
    path: "/docs/category/performance",
  },
  {
    icon: "/img/icons/mediacenter.svg",
    label: { fr: "Média-Center", en: "Media-Center", es: "Media-Center" },
    path: "/docs/category/media",
  },
  {
    icon: "/img/icons/club.svg",
    label: { fr: "Club", en: "Club", es: "Club" },
    path: "/docs/category/club",
  },
  {
    icon: "/img/icons/settings.svg",
    label: { fr: "Paramètres", en: "Settings", es: "Configuración" },
    path: "/docs/category/settings",
  },
  {
    icon: "/img/icons/scouting.svg",
    label: { fr: "Scouting", en: "Scouting", es: "Scouting" },
    path: "/docs/category/scouting",
  },
  {
    icon: "/img/icons/mobile-app.svg",
    label: { fr: "Mobile", en: "Mobile", es: "Móvil" },
    path: "/docs/category/mobile_app",
  },
  {
    /*
